import { BookOpen, Export, Star, Trash } from "@phosphor-icons/react";
...
export function BookCard({
  ...
  return (
    <div className="group relative">
      ...
      <div className="glass absolute top-2 right-2 flex gap-1 rounded-sm p-1 opacity-0 transition-opacity group-hover:opacity-100 focus-within:opacity-100">
        <GlassIconButton
